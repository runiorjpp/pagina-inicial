...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Selecione o botão de controle de áudio
    const audioControl = document.getElementById('audio-control');

    // Adicione um evento de clique ao botão de controle de áudio
    audioControl.addEventListener('click', function() {
        // Verifique se o áudio está pausado
        if (audio.paused) {
            // Se estiver pausado, reproduza o áudio
            audio.play();
            // Altere o texto do botão para "Mute"
            audioControl.textContent = "Mute";
        } else {
            // Se estiver tocando, pause o áudio
            audio.pause();
            // Altere o texto do botão para "Unmute"
